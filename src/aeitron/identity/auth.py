"""Native Aeitron JWT auth middleware.
...
class AuthConfig:
    ...
    issuer: str = "aeitron-local"
    audience: str = "aeitron-api"
    ...
    def from_env(cls) -> "AuthConfig":
        return cls(
            enabled=os.environ.get("AEITRON_AUTH_ENABLED", "0") == "1",
            quota_enabled=os.environ.get("AEITRON_QUOTA_ENABLED", "0") == "1",
            jwt_secret=os.environ.get("AEITRON_JWT_SECRET"),
            allow_token_issue=os.environ.get("AEITRON_ALLOW_TOKEN_ISSUE", "0") == "1",
            token_issue_key=os.environ.get("AEITRON_TOKEN_ISSUE_KEY"),
