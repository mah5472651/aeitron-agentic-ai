"""Consolidated Aeitron command line entrypoint."""
...
from src.aeitron.shared.schemas import AeitronRunRequest


async def run_smoke(args: argparse.Namespace) -> dict[str, object]:
    report = await AeitronRuntime().run(
        AeitronRunRequest(
            prompt=args.prompt,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the consolidated Aeitron runtime.")
