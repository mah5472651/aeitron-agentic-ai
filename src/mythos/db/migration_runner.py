...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Apply Mythos Postgres migrations.")
    parser.add_argument("--database-url", default=os.environ.get("MYTHOS_DATABASE_URL", ""))
...
def main() -> None:
    ...
    if not args.database_url:
        raise SystemExit("MYTHOS_DATABASE_URL or --database-url is required")
