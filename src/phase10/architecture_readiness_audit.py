...
def check_phase_files() -> AuditItem:
    ...
    required = [
        ...
        "scripts/run_mythos_v1_backend_comparison.ps1",
...
def collect_done_and_remaining(items: list[AuditItem]) -> tuple[list[str], list[str], list[str]]:
        ...
        "Mythos V1 consolidates release gating, capability ownership, backend comparison, project-isolated memory, strict API policy, UI telemetry, and GPU training preflight without adding another disconnected phase.",
    ]
    remaining = []
    constraints = []
