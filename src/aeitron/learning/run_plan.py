"""Generate an executable first-run plan for serious Aeitron data collection."""
...
from src.aeitron.learning.resource_catalog import ResourceCatalogReport, write_resource_catalog_report
...
class DataRunPlanConfig(StrictModel):
    ...
    postgres_dsn: str = "postgresql://user:pass@postgres:5432/aeitron"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prepare a serious Aeitron data collection run.")
    ...
    parser.add_argument("--postgres-dsn", default="postgresql://user:pass@postgres:5432/aeitron")
    parser.add_argument("--object-store-uri", default="s3://aeitron-datasets/pretraining")
