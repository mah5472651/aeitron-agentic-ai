...
from src.mythos.evaluation.benchmarks import BenchmarkHarness, BenchmarkRunReport, BenchmarkTask, built_in_security_tasks
from src.mythos.model_ops.checkpoint_compare import (
    DEFAULT_PROMPTS,
    GenerationConfig,
    PromptCase,
    _load_model,
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run deterministic Mythos checkpoint evaluation.")
