"""Production readiness gate for large Aeitron data-platform runs."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Check Aeitron data-platform production readiness.")
