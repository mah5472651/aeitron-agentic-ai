...
def load_report_summary(path: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "baseline_score": payload.get("baseline_score") if payload.get("baseline_score") is not None else baseline.get("overall_score"),
        "candidate_score": payload.get("candidate_score") if payload.get("candidate_score") is not None else candidate.get("overall_score"),
        "endpoint_available": payload.get("endpoint_available"),
