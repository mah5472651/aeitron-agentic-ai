"""Strict license filtering for Aeitron training corpora."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Filter Aeitron JSONL rows by approved training-data license.")
